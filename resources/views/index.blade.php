...
<!-- /NurseRent Section -->
    ...
    <section id="doctors" class="doctors section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <span>Select Nurse Location:</span>
        </label>
          <div class="col-md-6">
          <select id="township" name="township_id" class="form-control" onchange="handleTownshipChange()">
...
<div class="col-md-4">
  ...
  <footer id="footer" class="footer light-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Za Bu Hein</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
...
function handleTownshipChange() {
    ...
    nurseByTownship.forEach((nurse, index) => {
        ...
        nurseCard.innerHTML = `
            <div class="team-member d-flex align-items-start">
                <div class="pic"><img src="${nurse.image || '../assets/img/doctors/default.jpg'}" class="img-fluid" alt=""></div>
                <div class="member-info">
                    <h4>${nurse.name}</h4>
                    <span>${nurse.specialty || 'Specialty not provided'}</span>
                    <p>${nurse.description || 'No description available'}</p>
                </div>
            </div>
        `;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('township').addEventListener('change', handleTownshipChange);
});
</script>